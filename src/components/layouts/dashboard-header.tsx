      ...
      <div className='flex flex-1 justify-center px-8'>
        <div className='relative w-full max-w-md'>
          <Input
            ...
            className='font-sf-pro h-10 w-full rounded-full border border-gray-300 bg-gray-50 px-4 pr-10 text-[14px] leading-5 font-normal tracking-[-0.01em] text-gray-700 placeholder-gray-500 focus:border-gray-400 focus:bg-white focus:ring-0 focus:outline-none'
          />
