...
export const FilterModal = ({ open, onOpenChange, onApplyFilters, initialFilters, prospekData }: FilterModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-md'>
        <DialogHeader>
          <DialogTitle>Filter Data Analisa</DialogTitle>
          <DialogDescription>Atur filter untuk menampilkan data analisa sesuai kebutuhan</DialogDescription>
        </DialogHeader>
